...
def statement(invoice, plays):
    ...
    for perf in invoice['performances']:
        play = play_for(perf, plays)  #calling the helper function that I wrote up above
        this_amount = amount_for(perf, play) #calling the helper function that I wrote up above
